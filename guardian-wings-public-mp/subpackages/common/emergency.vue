<template>
  <view class="emergency-page">
    ...
    <view class="report-entry" @click="goReport">
      ...
      <uni-icons type="right" size="24" color="#1B4B8C" />
    </view>
  </view>
</template>
...
.guide-expand { width: 48rpx; height: 48rpx; display: flex; align-items: center; justify-content: center; transition: transform 0.3s; &.expanded { transform: rotate(180deg); } }
