  ...
  <view class="report-page">
    ...
    <view class="form-container">
        ...
        <view class="type-grid">
          ...
          >
            <view class="type-icon">
              <uni-icons :type="type.icon" :size="42" :color="type.color" />
            </view>
      ...
      <view class="form-section">
        ...
        <view class="location-input">
          <uni-icons type="location-filled" size="22" color="#6B7280" />
          <input
            class="location-text"
          ...
          <view class="current-location-btn" @click="getCurrentLocation" :class="{ loading: locating }">
            <uni-icons type="navigate-filled" size="20" color="#FFFFFF" />
          </view>
        </view>
        <!-- 手动修改地址 -->
        <input
      ...
      <view class="form-section">
        ...
        <view class="upload-container">
          ...
          <view v-if="formData.images.length < 6" class="upload-btn" @click="chooseImage">
            <uni-icons type="image-filled" size="34" color="#2D6A4F" />
      ...
      <view class="form-section">
        <view class="anonymous-row">
          <view class="anonymous-left">
            <uni-icons type="person-filled" size="28" color="#6B7280" />
    ...
    <view class="submit-container">
      <button class="submit-btn" @click="submitReport" :disabled="submitting">
        <uni-icons v-if="!submitting" type="paperplane-filled" size="22" color="#FFFFFF" />
      ...
      try {
        ...
        const res = await uniCloud.callFunction({
          ...
          data: {
            action: 'submitReport',
            params: {
              user_id:     this.formData.anonymous ? '' : uid,
              is_anonymous: this.formData.anonymous,
