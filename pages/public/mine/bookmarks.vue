      ...
      <view v-else-if="list.length > 0" class="bird-grid">
        ...
        >
          ...
          <view class="bird-info">
            ...
            <view class="level-tag" :style="getLevelStyle(item.protectionLevel)">
...
export default {
  ...
  methods: {
    ...
    getLevelStyle(level) {
      const map = {
        '一级': { background: '#FEE2E2', color: '#DC2626' },
        '二级': { background: '#FEF3C7', color: '#F59E0B' },
        '三级': { background: '#D1FAE5', color: '#10B981' },
        '濒危': { background: '#EDE9FE', color: '#8B5CF6' }
      }
...
.level-tag { display: inline-block; padding: 4rpx 14rpx; border-radius: 6rpx; font-size: 20rpx; font-weight: 500; }
