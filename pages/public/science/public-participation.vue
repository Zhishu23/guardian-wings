    ...
    <view class="hero-section">
      ...
      <view class="hero-icon">
        <svg viewBox="0 0 80 80" fill="none">
          ...
          <circle cx="40" cy="28" r="8" stroke="#FFFFFF" stroke-width="2.5" fill="none"/>
          <path d="M24 54C24 46 31 41 40 41C49 41 56 46 56 54" stroke="#FFFFFF" stroke-width="2.5" stroke-linecap="round" fill="none"/>
          <circle cx="26" cy="32" r="5" stroke="rgba(255,255,255,0.6)" stroke-width="2" fill="none"/>
          <circle cx="54" cy="32" r="5" stroke="rgba(255,255,255,0.6)" stroke-width="2" fill="none"/>
        </svg>
      </view>
            ...
            <view class="p-content">
              ...
              <view class="p-action" @click="p.action && p.action()">
                ...
                <svg viewBox="0 0 24 24" fill="none" style="width:24rpx;height:24rpx;">
                  <path d="M9 6L15 12L9 18" stroke="#409EFF" stroke-width="2" stroke-linecap="round"/>
                </svg>
              </view>
            </view>
          </view>
